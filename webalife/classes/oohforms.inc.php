...
include(CMS_CLASSES . "of_text.inc.php");
include(CMS_CLASSES . "of_select.inc.php");
include(CMS_CLASSES . "of_radio.inc.php");
include(CMS_CLASSES . "of_checkbox.inc.php");
include(CMS_CLASSES . "of_textarea.inc.php");
include(CMS_CLASSES . "of_file.inc.php");
