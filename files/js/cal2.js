...
function showCal(name) {
  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
	...
	x=(screen.width-calWidth)/2;
	y=(screen.height-calHeight)/2;
	
	if (!hasCal) {
      if (isIE || isOpera6) {
        calWin=window.open("","cal","toolbar=0,width="+calWidth+",height="+calHeight+",left="+x+",top="+y);
      }
      else {
        calWin=window.open("","cal","toolbar=0,width="+calWidth+",height="+calHeight+",screenx="+x+",screeny="+y);
      }
    }
